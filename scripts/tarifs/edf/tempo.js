abonnements.push({
    ...
    prices: [
        { puissance: 6, abonnement: 15.59 },
        { puissance: 9, abonnement: 19.38 },
        { puissance: 12, abonnement: 23.07 },
        { puissance: 15, abonnement: 26.47 },
        { puissance: 18, abonnement: 30.04 },
        { puissance: 30, abonnement: 44.73 },
        { puissance: 36, abonnement: 52.42 }
    ].map(item => ({
        ...item,
        bleu: {
            prixKwhHC: 13.25,
